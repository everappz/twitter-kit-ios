...
extern NSString *const TWTRNetworkingErrorDomain;
extern NSString *const TWTRNetworkingUserAgentHeaderKey;
extern NSString *const TWTRNetworkingStatusCodeKey;

#pragma mark - HTTP Headers
extern NSString *const TWTRContentTypeHeaderField;
extern NSString *const TWTRContentLengthHeaderField;
extern NSString *const TWTRContentTypeURLEncoded;
extern NSString *const TWTRAcceptEncodingHeaderField;
extern NSString *const TWTRAcceptEncodingGzip;

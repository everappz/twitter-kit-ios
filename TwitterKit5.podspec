Pod::Spec.new do |s|
  ...
  s.authors = "Tao Ren"
  s.platform = :ios, "12.0"
  s.source = { :http => "https://github.com/everappz/twitter-kit-ios/releases/download/v#{s.version}/iOS.zip" }
  s.vendored_frameworks = "iOS/TwitterCore.framework", "iOS/TwitterKit.framework"
